...
$justificationsBasePathCustom = Join-Path $analyzersFilesBasePath $project.Name
$justificationsBasePathCustom = Join-Path $justificationsBasePathCustom "Justifications.cs"
